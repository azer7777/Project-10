...
class Issue(models.Model):
    ...
    assignee = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name="assigned_issues", blank=True, null=True
    )
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name="authored_comments", blank=True, null=True
    )
